...
export default function ReceivedPage() {
  ...
  return (
    <>
      <h2 className="text-xl font-bold mb-6">Received
        <span className="ml-2 inline-flex items-center justify-center bg-green-100 text-green-800 text-xs font-medium rounded-full h-5 w-5">1</span>
      </h2>
